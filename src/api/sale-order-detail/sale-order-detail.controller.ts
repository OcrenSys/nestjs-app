...
export class SaleOrderDetailController {
  constructor(private readonly saleOrderDetailService: SaleOrderDetailService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateSaleOrderDetailDto: UpdateSaleOrderDetailDto) {
